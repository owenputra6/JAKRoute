...
Jangan menghitung satu user beberapa kali dalam satu snapshot. Luas memakai satuan
meter lokal. Data sumber user mencantumkan posisi, lantai, bobot dan waktu snapshot.
Bobot keramaian penghuni berbeda dengan bobot preferensi pengguna pencari rute.
